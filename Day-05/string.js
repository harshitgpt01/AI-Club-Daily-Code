...
let message = " Bhaiya bhut bade badmash hai. \nWo bhut ache insaan hai.";
console.log(message);
// escape character \
let comment = "Bhaiya bhut bade badmash hai. \\nWo bhut ache insaan hai."
console.log(comment);
...
let lasteststring = new String("Hello Coder");
